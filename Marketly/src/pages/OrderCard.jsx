    ...
    return (
        <div key={order.id} className="order-card">
            ...
            <div className="order-info">
                ...
                <p className="order-value">{new Date(order.datePlaced).toLocaleDateString("en-US", {
                    month: "long",
                    day: "numeric",
                    year: "numeric",
                })}</p>
            ...
            {order.status === "Completed" && order.dateCompleted && (
                <div className="order-info">
                    ...
                    <p className="order-value">{new Date(order.dateCompleted).toLocaleDateString("en-US", {
                        month: "long",
                        day: "numeric",
                        year: "numeric",
                    })}</p>
